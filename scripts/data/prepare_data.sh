...
model_path=/andon_AI/Qwen/Qwen3-4B #Qwen/Qwen3-4B
...
train_data_path=/shenlb/zwf-spec/train-v1/deepspec/test-set/perfectblend_train.jsonl #train_datasets/qwen3_4b/perfectblend_train_regen.jsonl
